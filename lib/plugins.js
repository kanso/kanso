...
/**
 * Extracts the available postprocessors from an array of loaded plugin objects
 * Returns an array of postprocessor functions ordered by priority.
 *
 * @param {Array} plubins
 * @returns {Array}
 */

exports.postprocessors = function (plugins) {
    return plugins.reduce(function (postprocessors, p) {
        return postprocessors.concat(p.postprocessors || []);
    }, []);
};
