...
exports.load = function (name, root, paths, source, callback) {
    ...
    exports.resolve(name, paths, source, function (err, p) {
        ...
        settings.load(p, function (err, cfg) {
            ...
            exports.loadDependencies(p, cfg, paths, source,
...
exports.loadDependencies = function (p, cfg, paths, source, callback) {
