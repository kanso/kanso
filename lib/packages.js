...
exports.load = function (name, paths, source, options, callback) {
    ...
    exports.readMeta(pcache, name, null, paths, source, null, function (err) {
        if (err) {
            return callback(err);
        }
        ...
        function (err, docs) {
            ...
            exports.postprocess(pcache, rpath, rcfg, doc, function (err, doc) {
                ...
                doc.kanso = rcfg;
                doc.kanso._build_time = utils.ISODateString(new Date());
...
exports.readMeta = function (cache, name, range, paths, source, parent, cb) {
    ...
    exports.resolve(name, range, paths, source, function (err, p) {
        if (err) {
            return cb(err);
        }
        cached.path = p;
    ...
    async.forEach(deps, function (dep, cb) {
        ...
        if (cache[dep]) {
            ...
            if (cached.ready) {
                ...
                cached.ev.on('ready', function (pkg) {
                    return cb(null, pkg);
                });
                return;
            }
            ...
            exports.readMeta(cache, dep, range, paths, source, pkg.name, cb);
        }
    }, callback);
};
