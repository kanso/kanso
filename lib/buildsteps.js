...
BuildManager.prototype.finalSteps = function () {
    return this.steps.filter(function (s) {
        if (s.fn.after) {
            for (var i = 0, len = s.fn.after.length; i < len; i++) {
                if (s.fn.after[i] === '*') {
                    return true;
                }
            }
...
BuildManager.prototype.prepareFinal = function (steps) {
    return steps.map(function (s) {
        s.fn.after = s.fn.after.filter(function (a) {
            return a !== '*';
        });
        return s;
    });
...
BuildManager.prototype.reverseBefores = function () {
    ...
    for (var i = 0, len = this.steps.length; i < len; i++) {
        ...
        var fn = curr.fn;
        if (fn && fn.before) {
            var steps = fn.before.reduce(function (arr, b) {
                return arr.concat(
            ...
            steps.forEach(function (s) {
                ...
                s.fn.after = s.fn.after || [];
                s.fn.after.push(curr.toString());
            });
            delete fn.before;
        }
    }
